...
function Switch() {
    const { enabled, onSwitchHandler } = useColor();
    const [enabledToggle, setEnabledToggle] = useState(enabled);

    // `enabled` o'zgarsa, `enabledToggle` ni ham yangilash
    useEffect(() => {
    ...
    return (
        <Tooltip content="Light / Dark" position="top" px="26px">
            <div className='cursor-pointer transition-all'>
                <div className='sidebar_switch_container flex items-center justify-center flex-col'>
                    <input type="checkbox" id="darkmode-toggle" checked={enabledToggle} onChange={changeToggle} />
